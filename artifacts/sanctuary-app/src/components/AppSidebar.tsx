          ...
          {playlist.length === 0 ? (
            <div className="flex flex-col items-center py-4 gap-2">
              ...
              <button onClick={onUploadClick}
                className="text-[11px] font-sans text-primary/70 hover:text-primary transition-colors flex items-center gap-1">
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain px-3 pb-4">
          {playlist.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-10 gap-3">
              ...
              <button onClick={onUploadClick}
                className="text-[12px] font-sans text-primary/70 hover:text-primary transition-colors flex items-center gap-1.5">

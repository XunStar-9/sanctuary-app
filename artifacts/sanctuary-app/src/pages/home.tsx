...
import { 
  ...
  PenLine, Search, Plus, FileText, Settings, Heart, ListMusic, Save
} from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-[100dvh] bg-background text-foreground flex items-center justify-center p-4 md:p-8 font-serif selection:bg-primary/20 overflow-hidden">
      <div className="w-full max-w-[1400px] h-[90vh] min-h-[700px] bg-white/40 dark:bg-black/20 backdrop-blur-3xl rounded-[2rem] border border-white/50 dark:border-white/10 shadow-2xl overflow-hidden flex flex-col md:flex-row gap-0">
        ...
        <div className="flex-1 flex flex-col h-full bg-card/60 relative group min-w-0">
          
          {/* Notes Header */}
          <div className="h-20 flex items-center justify-between px-4 md:px-8 border-b border-border/40 shrink-0 gap-4">
            ...
            <h1 className="text-sm font-medium tracking-widest uppercase text-muted-foreground hidden md:block">Sanctuary</h1>
          ...
          <div className="flex-1 flex overflow-hidden min-h-0">
            {/* Notes Sidebar List */}
            <div className="w-[280px] md:w-80 border-r border-border/40 flex flex-col shrink-0 bg-secondary/20 h-full">
            ...
            {/* Note Editor Area */}
            <div className="flex-1 flex flex-col p-6 md:p-12 overflow-y-auto h-full">
              {activeNote ? (
                <div className="max-w-2xl mx-auto w-full mt-4 h-full flex flex-col">
                  ...
                  <textarea
                    ...
                    onChange={(e) => updateActiveNote({ 
                      ...
                      preview: e.target.value.substring(0, 80) + '...'
                    })}
          ...
          <div className="p-8 pb-4 flex flex-col items-center justify-center shrink-0">
            ...
            <div className="w-full mb-8 px-2">
              <Slider
                ...
                max={100}
                step={1}
                className="[&_[role=slider]]:h-3 [&_[role=slider]]:w-3 [&_[role=slider]]:opacity-0 group-hover:[role=slider]:opacity-100 transition-opacity"
